...
assert.equal(_test.constants.ARK_TIMEOUT_MS, 26000)
assert.equal(_test.constants.DOWNLOAD_TIMEOUT_MS, 5000)
assert.equal(_test.constants.TOTAL_TIMEOUT_MS, 27000)
assert.equal(_test.constants.SYNC_BUDGET_MS, 29000)
assert.equal(_test.effectiveArkTotalTimeout(40000, 10000), 27000)
assert.equal(_test.effectiveArkTotalTimeout(34000, 10000), 24000)
